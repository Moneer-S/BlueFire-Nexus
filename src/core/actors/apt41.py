...
class APT41:
    ...
    def __init__(self):
        ...
        self.name = "APT41"
        self.aliases = ["Winnti", "BARIUM", "Wicked Panda", "Double Dragon"]
        self.suspected_origin = "China"
        self.primary_focus = ["Supply Chain Attacks", "Cyber Espionage"]
        ...
        self.intelligence = APT41Intelligence()
