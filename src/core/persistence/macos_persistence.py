...
class MacOSPersistence:
    ...
    def establish(self, technique: str, details: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if handler:
            ...
            try:
                ...
                logger.error(
                    f"Error executing macOS persistence technique '{technique}': {e}", exc_info=True
                )
    ...
    def _handle_launch_agent(self, details: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if not label or not command_str:
            return {
                "status": "failure",
                "reason": "Missing required parameters: 'label' and 'command'.",
            }
        ...
        if start_interval is not None:
            try:
                ...
                return {
                    "status": "failure",
                    "reason": f"Invalid start_interval: {start_interval}. Must be integer seconds.",
                }
