...
_SOURCE_AUDIT_PATHS = (
    ...
    "bluefire/receiver_defense_ownership.py",
    ...
    "bluefire/graph_ai_edit_contract.py",
    "bluefire/ai_authorized_access.py",
    "bluefire/ai_broker_live_authorization.py",
    "bluefire/product_store_ai_authorizations.py",
    "bluefire/ai_broker_contract.py",
    "bluefire/ai_broker.py",
    "bluefire/ai_broker_bootstrap.py",
    "bluefire/ai_broker_channel.py",
    "bluefire/ai_broker_worker.py",
    ...
    "bluefire/ai_transport.py",
    "bluefire/_ai_transport_worker.py",
    "bluefire/prepared_lab.py",
    "bluefire/prepared_lab_guest.py",
    "bluefire/prepared_lab_runtime.py",
    "bluefire/prepared_lab_install.py",
...
_PYTHON_BOUNDARIES = {
    ...
    "prepared_lab_broker.py": {
        "passed": True,
        "shell_imports": 1,
        "process_calls": ["os.execve", "os.execve", "os.execve", "subprocess.Popen.__init__"],
        "unexpected_findings": [],
    },
    "prepared_lab_ui_bootstrap.py": {
        "passed": True,
        "shell_imports": 1,
