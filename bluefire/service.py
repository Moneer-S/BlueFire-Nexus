...
class BlueFireService(RunnerManagementServiceMixin, ReceiverDefenseServiceMixin):
    ...
    def action_packages(self) -> Mapping[str, Any]:
        ...
        return ActionPackageOperations(self).action_packages()

    def action_package(self, package_id: str, *, version: str | None = None) -> Mapping[str, Any]:
        return ActionPackageOperations(self).action_package(package_id, version=version)

    def trust_action_package_publisher(self, request: Mapping[str, Any]) -> Mapping[str, Any]:
        return ActionPackageOperations(self).trust_action_package_publisher(request)

    def transition_action_package_publisher(
        self, publisher_id: str, key_id: str, action: str, request: Mapping[str, Any]
    ) -> Mapping[str, Any]:
        return ActionPackageOperations(self).transition_action_package_publisher(
            publisher_id, key_id, action, request
        )

    def install_action_package(self, request: Mapping[str, Any]) -> Mapping[str, Any]:
        return ActionPackageOperations(self).install_action_package(request)

    def activate_action_package(
        self, package_id: str, version: str, request: Mapping[str, Any]
    ) -> Mapping[str, Any]:
        return ActionPackageOperations(self).activate_action_package(package_id, version, request)

    def deactivate_action_package(
        self, package_id: str, version: str, request: Mapping[str, Any]
    ) -> Mapping[str, Any]:
        return ActionPackageOperations(self).deactivate_action_package(package_id, version, request)

    def remove_action_package(
        self, package_id: str, version: str, request: Mapping[str, Any]
    ) -> Mapping[str, Any]:
        return ActionPackageOperations(self).remove_action_package(package_id, version, request)
    ...
    def intake_reviewed_t1082(self, request: Mapping[str, Any]) -> Mapping[str, Any]:
        ...
        return ReviewedSourceIntake(self, _management_identifier).intake_reviewed_t1082(request)
