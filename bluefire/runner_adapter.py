...
from .runner_provider_values import (
    ...
    _validate_provider_parameter,
)
from .util import json_clone as json_clone
...
_PROVIDER_ACTION_OUTPUT_SCHEMA = provider_values._PROVIDER_ACTION_OUTPUT_SCHEMA
...
def _provider_parameters(binding: Mapping[str, Any], values: Mapping[str, Any]) -> dict[str, Any]:
    return provider_values._provider_parameters(
        binding, values, validate=_validate_provider_parameter
    )


def _provider_outputs(binding: Mapping[str, Any], value: Any) -> dict[str, Any]:
    return provider_values._provider_outputs(binding, value, output_value=_provider_output_value)
