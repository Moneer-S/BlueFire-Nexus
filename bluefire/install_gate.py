...
def _archive_committed_source(repository: Path, source: Path, archive_path: Path) -> None:
    ...
    with tarfile.open(archive_path, "r:") as archive:
        _extract_validated_archive(archive, source)
...
def _extract_validated_archive(archive: tarfile.TarFile, source: Path) -> None:
    archive_io.extract_validated_archive(archive, source, is_link_or_reparse=_is_link_or_reparse)
