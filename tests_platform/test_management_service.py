...
def test_research_source_requires_strict_pinned_matching_metadata(
    ...
    document = {
        ...
        "file_level_license_review": "Example LICENSE reviewed; no source files copied.",
        ...
        "attribution": "Example project attribution retained.",
        "security_review": "No executable content is fetched or executed.",
