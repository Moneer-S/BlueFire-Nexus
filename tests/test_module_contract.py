...
_MINIMAL_PARAMS: Dict[str, Dict[str, Any]] = {
    ...
    "credential_access": {"technique": "lsass_dump", "target": "lab-host"},
    "lateral_movement": {"technique": "psexec", "source": "lab-attacker", "target": "lab-host"},
    "privilege_escalation": {"technique": "token_impersonation", "target": "lab-host"},
    "impact": {"technique": "data_encryption", "target": "lab-host"},
