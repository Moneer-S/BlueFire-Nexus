...
export interface ComparisonSummary {
  ...
  replay_lineage?: {
    ...
    source_scenario_digest?: string | null;
    variant_types?: string[];
    from_step_id?: string | null;
    swap_step_id?: string | null;
    swap_behavior_id?: string | null;
    parameter_override_steps?: string[];
    parameter_override_names?: Record<string, string[]>;
    action_implementations_changed?: boolean;
    action_implementation_override_steps?: string[];
    action_reselection_steps?: string[];
    ai_changed?: boolean;
    autonomy_from?: string | null;
    autonomy_to?: string | null;
    ai_provider_changed?: boolean;
    ai_provider_from?: string | null;
    ai_provider_to?: string | null;
    profile_changed?: boolean;
    defense_change_declared?: boolean;
    defense_change_digest?: string | null;
  };
  path: string[];
...
export interface ComparisonDelta {
  ...
  replay_lineage_delta?: {
    ...
    from_state?: string;
    to_state?: string;
    from_variant_types?: string[];
    to_variant_types?: string[];
    from_lineage_digest?: string | null;
    to_lineage_digest?: string | null;
    source_run_id?: string | null;
    source_scenario_digest?: string | null;
    parameter_override_steps?: string[];
    action_implementations_changed?: boolean;
