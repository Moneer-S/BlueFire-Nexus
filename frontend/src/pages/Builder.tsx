...
function Inspector({ scenario, step, behavior, behaviors, actions, updateStep, updateScenario, selectedAction, executeMode, onAction, onAlternative }: { scenario: Scenario; step: ScenarioStep; behavior: Behavior; behaviors: Map<string, Behavior>; actions: Map<string, ActionDefinition>; updateStep: (id: string, update: (step: ScenarioStep) => ScenarioStep) => void; updateScenario: (scenario: Scenario) => void; selectedAction: string; executeMode: boolean; onAction: (id: string) => void; onAlternative: (stepId: string, behaviorId: string) => void }) {
