      ...
      {!jobId ? <>
        ...
        {parent ? <>
          ...
          {proposal ? <>
            ...
            <div className="method-change"><div><span>Original method</span><strong>{displayTitle(proposal.option.title_from)}</strong></div><span aria-hidden="true">→</span><div><span>Proposed method</span><strong>{displayTitle(proposal.option.title)}</strong></div></div>
