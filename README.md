...
[![tests](https://img.shields.io/badge/tests-2144%20passed-blue)](#development--tests)
...
- 2144 passing tests, 5 intentional skips, 0 failures (~85-155s full-suite wallclock).
