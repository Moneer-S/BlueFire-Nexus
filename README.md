...
[![tests](https://img.shields.io/badge/tests-2150%20passed-blue)](#development--tests)
...
- 2150 passing tests, 5 intentional skips, 0 failures (~85-155s full-suite wallclock).
