...
[![tests](https://img.shields.io/badge/tests-2094%20passed-blue)](#development--tests)
...
- 2094 passing tests, 5 intentional skips, 0 failures (~145-155s full-suite wallclock).
