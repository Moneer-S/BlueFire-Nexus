...
[![tests](https://img.shields.io/badge/tests-2127%20passed-blue)](#development--tests)
...
- 2127 passing tests, 5 intentional skips, 0 failures (~145-155s full-suite wallclock).
