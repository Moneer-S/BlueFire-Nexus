...
[![tests](https://img.shields.io/badge/tests-1678%20passed-blue)](#development--tests)
...
- 1678 passing tests, 5 intentional skips, 0 failures (~100-110s full-suite wallclock).
