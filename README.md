...
[![tests](https://img.shields.io/badge/tests-1599%20passed-blue)](#development--tests)
...
- 1599 passing tests, 5 intentional skips, 0 failures (~92-110s full-suite wallclock).
