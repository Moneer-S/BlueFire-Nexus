...
[![tests](https://img.shields.io/badge/tests-1455%20passed-blue)](#development--tests)
...
- 1455 passing tests, 5 intentional skips, 0 failures (~190s full-suite wallclock).
