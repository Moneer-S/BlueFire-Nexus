...
[![tests](https://img.shields.io/badge/tests-1768%20passed-blue)](#development--tests)
...
- 1768 passing tests, 5 intentional skips, 0 failures (~110-120s full-suite wallclock).
