...
[![tests](https://img.shields.io/badge/tests-1603%20passed-blue)](#development--tests)
...
- 1603 passing tests, 5 intentional skips, 0 failures (~96-110s full-suite wallclock).
