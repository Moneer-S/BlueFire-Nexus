...
[![tests](https://img.shields.io/badge/tests-1525%20passed-blue)](#development--tests)
...
- 1525 passing tests, 5 intentional skips, 0 failures (~98-110s full-suite wallclock).
