...
[![tests](https://img.shields.io/badge/tests-1808%20passed-blue)](#development--tests)
...
- 1808 passing tests, 5 intentional skips, 0 failures (~110-120s full-suite wallclock).
